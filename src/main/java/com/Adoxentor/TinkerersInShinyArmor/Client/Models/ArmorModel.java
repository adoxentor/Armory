...
public class ArmorModel implements IModel {

  List<List<MaterialModel>> partBlocks;
...
//    switch (i){
//      case 0:
//        return new ModelSta teComposition(originalState, TRSRTransformation.blockCenterToCorner(new TRSRTransformation(new Vector3f(0.5f,0.5f,0.5f), TRSRTransformation.quatFromXYZ(0, 0, (float) (i * Math.PI / 2)), null, null)));
//
//    }
