...
public class ItemLayerModel implements IRetexturableModel {
    ...
    static TextureAtlasSprite north,west,east,up,down,south;
    ...
    private static final BakedQuad buildQuad(
        ...
        if(transform.isPresent()&& b2)
        {
            Quat4f leftRot1 = transform.get().getLeftRot();
            Quat4f leftRot2= new Quat4f(leftRot1.x,-leftRot1.y,-leftRot1.z,leftRot1.getW());
            TRSRTransformation trsr=new TRSRTransformation(null, leftRot2,null,null);
            side=trsr.rotate(side);
        }
        //colors the quad by the side
//        TextureAtlasSprite sprite1=north;
//        switch (side){
//            case DOWN:
//                sprite1=down;
//                break;
...
//        try {
//            north=bakedTextureGetter.apply(new ResourceLocation("armory","items/red"));
//            east=bakedTextureGetter.apply(new ResourceLocation("armory","items/green"));
//            west=bakedTextureGetter.apply(new ResourceLocation("armory","items/yellow"));
//            up=bakedTextureGetter.apply(new ResourceLocation("armory","items/blue"));
//            down=bakedTextureGetter.apply(new ResourceLocation("armory","items/white"));
//            south=bakedTextureGetter.apply(new ResourceLocation("armory","items/black"));
//        }
//        catch (Exception e){
//            e.printStackTrace();
//        }
